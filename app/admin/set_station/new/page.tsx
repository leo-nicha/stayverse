...
export default function SetStationNewPage() {
  ...
  const currentDateTime = '2026-05-22 09:15:24';
      ...
      <div className="bg-white min-h-screen pb-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-6 py-4 border-b border-gray-100">
          <h1 className="text-xl font-bold text-gray-800 tracking-tight">
            {isTh ? 'สถานีรถไฟฟ้า > เพิ่ม' : 'Stations > Add'}
          </h1>
          ...
          <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-6">
                  ...
                  <div className="md:col-span-6 lg:col-span-4">
                    <input 
                      type="text" 
                      name="stationTh"
                      placeholder={isTh ? 'สถานี [TH]' : 'Station [TH]'}
                  ...
                  <div className="md:col-span-6 lg:col-span-4">
                    <input 
                      type="text" 
                      name="stationEn"
                      placeholder={isTh ? 'สถานี [EN]' : 'Station [EN]'}
            ...
            <div className="bg-gray-50/50 p-4 border-t border-gray-200 -mx-6 -mb-6 mt-6 flex gap-3 px-6">
              ...
              <button 
                type="button"
                onClick={() => setFormData({
                  line: 'BTS สายหลัก', stationTh: '', stationEn: '',
                  latitude: '', longitude: '', sort: '', status: true
                })}
