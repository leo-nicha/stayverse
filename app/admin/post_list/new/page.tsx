  ...
  return (
    <AdminShell activeItem="allListings">
      <div className="bg-[#f8f9fc] min-h-screen pb-12">
        ...
        <div className="p-6">
          {/* Tabs */}
          <div className="flex space-x-6 border-b border-gray-200 mb-6 px-4">
            <button 
          ...
          <form className="bg-white rounded-md shadow-sm border border-gray-200">
            ...
            <div className="p-6 space-y-4">
              {[
                { id: 'r_name', label: 'Name', placeholder: 'Name', warning: '' },
                { id: 'r_tel', label: 'Tel', placeholder: 'Tel', warning: '*ชี้แจงโปรดทราบ ระบบจะแสดงผลตามข้อมูลที่แจ้งการทำลีดติ้ง ข้อมูลที่แสดงคือ 0924153999' },
                { id: 'r_tel_1', label: 'Tel (สำรอง 1)', placeholder: 'Tel', warning: '*ชี้แจงโปรดทราบ ระบบจะแสดงผลตามข้อมูลที่แจ้งการทำลีดติ้ง ข้อมูลที่แสดงคือ' },
                { id: 'r_tel_2', label: 'Tel (สำรอง 2)', placeholder: 'Tel', warning: '*ชี้แจงโปรดทราบ ระบบจะแสดงผลตามข้อมูลที่แจ้งการทำลีดติ้ง ข้อมูลที่แสดงคือ' },
                { id: 'r_email', label: 'Email', placeholder: 'Email', warning: '*ชี้แจงโปรดทราบ ระบบจะแสดงผลตามข้อมูลที่แจ้งการทำลีดติ้ง ข้อมูลที่แสดงคือ kirk.bu@gmail.com' },
                { id: 'r_line', label: 'Line ID', placeholder: 'Line ID', warning: '*ชี้แจงโปรดทราบ ระบบจะแสดงผลตามข้อมูลที่แจ้งการทำลีดติ้ง ข้อมูลที่แสดงคือ @Propholic' },
                { id: 'r_whatsapp', label: 'WhatsApp ID', placeholder: 'WhatsApp ID', warning: '*ชี้แจงโปรดทราบ ระบบจะแสดงผลตามข้อมูลที่แจ้งการทำลีดติ้ง ข้อมูลที่แสดงคือ' },
                { id: 'r_wechat', label: 'WeChat ID', placeholder: 'WeChat ID', warning: '*ชี้แจงโปรดทราบ ระบบจะแสดงผลตามข้อมูลที่แจ้งการทำลีดติ้ง ข้อมูลที่แสดงคือ' },
                { id: 'r_kakao', label: 'KakaoTalk ID', placeholder: 'KakaoTalk ID', warning: '*ชี้แจงโปรดทราบ ระบบจะแสดงผลตามข้อมูลที่แจ้งการทำลีดติ้ง ข้อมูลที่แสดงคือ' },
              ].map((field) => (
              ...
              {buildingType !== "" && (
                <div className="space-y-4 pt-4 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center border-b border-gray-100 pb-4">
                    ...
                    <div className="md:col-span-3">
                      <input type="text" placeholder="ราคาขาย" className="w-full md:w-1/4 border border-gray-300 px-3 py-2 rounded text-[13px] focus:outline-none focus:border-[#0088ff]" />
                    </div>
                  </div>
                  ...
                  {['จำนวนห้องนอน', 'จำนวนห้องเอนกประสงค์', 'จำนวนห้องน้ำ'].map((label) => (
                    <div key={label} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                      <label className="text-[13px] font-medium text-gray-700 md:col-span-1">{label}</label>
                      <div className="md:col-span-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                    ...
                    <div className="md:col-span-3">
                      <input type="text" placeholder="พื้นที่" className="w-full md:w-1/6 border border-gray-300 px-3 py-2 rounded text-[13px] focus:outline-none focus:border-[#0088ff]" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                    ...
                    <div className="md:col-span-3">
                      <input type="text" placeholder="ชื่อประกาศ [TH]" className="w-full md:w-1/2 border border-gray-300 px-3 py-2 rounded text-[13px] focus:outline-none focus:border-[#0088ff]" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                    ...
                    <div className="md:col-span-3 flex gap-2">
                      <input type="text" placeholder="ชื่อประกาศ [EN]" className="w-full md:w-1/2 border border-gray-300 px-3 py-2 rounded text-[13px] focus:outline-none focus:border-[#0088ff]" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-start">
                    ...
                    <div className="md:col-span-3">
                      <textarea rows={4} placeholder="รายละเอียดห้อง [ถ้ามี]" className="w-full md:w-1/2 border border-gray-300 px-3 py-2 rounded text-[13px] focus:outline-none focus:border-[#0088ff]"></textarea>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-start border-b border-gray-100 pb-4">
                    ...
                    <div className="md:col-span-3 flex gap-2">
                      <textarea rows={4} placeholder="รายละเอียดห้อง [ถ้ามี] [EN]" className="w-full md:w-1/2 border border-gray-300 px-3 py-2 rounded text-[13px] focus:outline-none focus:border-[#0088ff]"></textarea>
                  ...
                  {/* PHOTOS */}
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center border-b border-gray-100 pb-4">
                    <label className="text-[13px] font-medium text-gray-700 md:col-span-1">All photo</label>
                    <div className="md:col-span-3 flex gap-2">
